...
fetch("https://api.airtable.com/v0/apphKFqKdClqcgF26/tblUJeRe8ao2unR2m", requestOptions)
  ...
  /* Give the values to the elements on the page from our APi call */
   ...
   document.querySelector('[profit1]').textContent = parsed.records[15].fields["Class 2 (Self employed)"]
   document.querySelector('[profit121-22]').textContent = parsed.records[15].fields["2021/22"]
   document.querySelector('[profit122-23]').textContent = parsed.records[15].fields["2022/23"]
