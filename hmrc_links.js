...
fetch("https://api.airtable.com/v0/apphKFqKdClqcgF26/tblYjacAWXqVfWCek", requestOptions)
  ...
  /* Give the values to the elements on the page from our APi call */
   ...
   document.querySelector('[link1]').textContent = parsed.records[5].fields.Link
   ...
   document.querySelector('[link2]').textContent = parsed.records[14].fields.Link
   ...
   document.querySelector('[link3]').textContent = parsed.records[9].fields.Link
   ...
   document.querySelector('[link4]').textContent = parsed.records[3].fields.Link
   ...
   document.querySelector('[link5]').textContent = parsed.records[7].fields.Link
   ...
   document.querySelector('[link6]').textContent = parsed.records[4].fields.Link
   ...
   document.querySelector('[link7]').textContent = parsed.records[8].fields.Link
   ...
   document.querySelector('[link8]').textContent = parsed.records[10].fields.Link
   ...
   document.querySelector('[link9]').textContent = parsed.records[0].fields.Link
   ...
   document.querySelector('[link10]').textContent = parsed.records[16].fields.Link
   ...
   document.querySelector('[link12]').textContent = parsed.records[12].fields.Link
   ...
   document.querySelector('[link13]').textContent = parsed.records[15].fields.Link
   ...
   document.querySelector('[link14]').textContent = parsed.records[11].fields.Link
   ...
   document.querySelector('[link15]').textContent = parsed.records[13].fields.Link
   ...
   document.querySelector('[link16]').textContent = parsed.records[6].fields.Link
   ...
   document.querySelector('[link17]').textContent = parsed.records[17].fields.Link
   ...
   document.querySelector('[link18]').textContent = parsed.records[1].fields.Link
