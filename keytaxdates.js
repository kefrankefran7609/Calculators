...
fetch("https://api.airtable.com/v0/apphKFqKdClqcgF26/tblHwOsBKACCHgHVY", requestOptions)
  ...
  console.log(parsed)
   /* Give the values to the elements on the page from our APi call  */
   document.querySelector('[task]').textContent = parsed.records[3].fields.Task
   document.querySelector('[taxyear]').textContent = parsed.records[3].fields["Tax Year"] 
   document.querySelector('[deadline]').textContent = parsed.records[3].fields.Deadline
   document.querySelector('[note]').textContent = parsed.records[3].fields.Note
   document.querySelector('[task1]').textContent = parsed.records[2].fields.Task
   document.querySelector('[taxyear1]').textContent = parsed.records[2].fields["Tax Year"] 
   document.querySelector('[deadline1]').textContent = parsed.records[2].fields.Deadline
   document.querySelector('[note1]').textContent = parsed.records[2].fields.Note
   document.querySelector('[task2]').textContent = parsed.records[9].fields.Task
   document.querySelector('[taxyear2]').textContent = parsed.records[9].fields["Tax Year"]  
   document.querySelector('[deadline2]').textContent = parsed.records[9].fields.Deadline
   document.querySelector('[note2]').textContent = parsed.records[9].fields.Note
   document.querySelector('[task3]').textContent = parsed.records[1].fields.Task
   document.querySelector('[taxyear3]').textContent = parsed.records[1].fields["Tax Year"]  
   document.querySelector('[deadline3]').textContent = parsed.records[1].fields.Deadline
   document.querySelector('[note3]').textContent = parsed.records[1].fields.Note
   document.querySelector('[task4]').textContent = parsed.records[4].fields.Task
   document.querySelector('[taxyear4]').textContent = parsed.records[4].fields["Tax Year"]  
   document.querySelector('[deadline4]').textContent = parsed.records[4].fields.Deadline
   document.querySelector('[note4]').textContent = parsed.records[4].fields.Note  
   document.querySelector('[task5]').textContent = parsed.records[10].fields.Task
   document.querySelector('[taxyear5]').textContent = parsed.records[10].fields["Tax Year"] 
   document.querySelector('[deadline5]').textContent = parsed.records[10].fields.Deadline
   document.querySelector('[note5]').textContent = parsed.records[10].fields.Note
   document.querySelector('[task6]').textContent = parsed.records[0].fields.Task
   document.querySelector('[taxyear6]').textContent = parsed.records[0].fields["Tax Year"]
   document.querySelector('[deadline6]').textContent = parsed.records[0].fields.Deadline
   document.querySelector('[note6]').textContent = parsed.records[0].fields.Note  
   document.querySelector('[task7]').textContent = parsed.records[8].fields.Task
   document.querySelector('[taxyear7]').textContent = parsed.records[8].fields["Tax Year"] 
   document.querySelector('[deadline7]').textContent = parsed.records[8].fields.Deadline
   document.querySelector('[note7]').textContent = parsed.records[8].fields.Note
   document.querySelector('[task8]').textContent = parsed.records[5].fields.Task
   document.querySelector('[taxyear8]').textContent = parsed.records[5].fields["Tax Year"]  
   document.querySelector('[deadline8]').textContent = parsed.records[5].fields.Deadline
   document.querySelector('[note8]').textContent = parsed.records[5].fields.Note
   document.querySelector('[task9]').textContent = parsed.records[7].fields.Task
   document.querySelector('[taxyear9]').textContent = parsed.records[7].fields["Tax Year"]  
   document.querySelector('[deadline9]').textContent = parsed.records[7].fields.Deadline
   document.querySelector('[note9]').textContent = parsed.records[7].fields.Note
   document.querySelector('[task10]').textContent = parsed.records[6].fields.Task
   document.querySelector('[taxyear10]').textContent = parsed.records[6].fields["Tax Year"]  
   document.querySelector('[deadline10]').textContent = parsed.records[6].fields.Deadline
   document.querySelector('[note10]').textContent = parsed.records[6].fields.Note  
 })
