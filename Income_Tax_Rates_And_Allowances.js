...
fetch("https://api.airtable.com/v0/apphKFqKdClqcgF26/tbl859m8WhwIV59tT", requestOptions)
  ...
  /* Give the values to the elements on the page from our APi call */
   ...
   document.querySelector('[maincome]').textContent = parsed.records[3].fields["Main allowances"]
   document.querySelector('[maincome21-22]').textContent = parsed.records[3].fields["2021/22"]
   document.querySelector('[maincome22-23]').textContent = parsed.records[3].fields["2022/23"]
